...
def compute_fid(opts, max_real, num_gen, sfid=False, rfid=False):
    ...
    mu_real, sigma_real = metric_utils.compute_feature_stats_for_dataset(
        opts=opts,dataset_kwargs=opts.dataset_kwargs, detector_url=detector_url, detector_kwargs=detector_kwargs,
        rel_lo=0, rel_hi=0, capture_mean_cov=True, max_items=max_real, sfid=sfid).get_mean_cov()
    opts.dataset_kwargs["path"] = "/home/peter/Downloads/iclr_imgs/prime_train_large_val_filter/"
    #opts.dataset_kwargs["path"] = "/home/peter/Downloads/iclr_imgs/imagenet_object_localization_patched2019/ILSVRC/Data/CLS-LOC/prime_resnet50_val_only_datasets/val_only/"
    #
    mu_gen, sigma_gen = metric_utils.compute_feature_stats_for_dataset(
        opts=opts,dataset_kwargs=opts.dataset_kwargs, detector_url=detector_url, detector_kwargs=detector_kwargs,
        rel_lo=0, rel_hi=1, capture_mean_cov=True, max_items=max_real, sfid=sfid).get_mean_cov()
